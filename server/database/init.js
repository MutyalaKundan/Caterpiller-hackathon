...
export const initializeDatabase = async () => {
  return new Promise((resolve, reject) => {
    ...
    db.serialize(() => {
      ...
      db.run(
        `CREATE INDEX IF NOT EXISTS idx_rental_dates ON rentals(rental_start_date, rental_end_date_planned)`
      );
      db.run(
        `CREATE INDEX IF NOT EXISTS idx_rental_status ON rentals(rental_status)`
      );
      db.run(
        `CREATE INDEX IF NOT EXISTS idx_usage_timestamp ON equipment_usage(timestamp)`
      );
      db.run(
        `CREATE INDEX IF NOT EXISTS idx_usage_equipment_date ON equipment_usage(equipment_id, timestamp)`
      );
...
const insertSeedData = () => {
  db.serialize(() => {
    ...
    const siteData = [
      [
        "ST001",
        "Downtown Houston Project",
        "Commercial",
        "100 Main Street, Houston, TX",
        "Houston",
        "TX",
        "77002",
        29.7604,
      ...
      [
        "ST002",
        "Dallas Highway Extension",
        "Infrastructure",
        "2000 Interstate 35, Dallas, TX",
        "Dallas",
        "TX",
        "75201",
        32.7767,
      ...
      [
        "ST004",
        "San Antonio Bridge Repair",
        "Infrastructure",
        "1500 River Walk, San Antonio, TX",
        "San Antonio",
        "TX",
        "78205",
        29.4241,
      ...
      [
        ...
        "Industrial",
        "800 Industrial Park Dr, Fort Worth, TX",
        "Fort Worth",
        "TX",
        "76102",
        32.7555,
    ...
    const maintenanceData = [
      ...
      [
        ...
        "2024-08-05",
        "Emergency",
        "Transmission failure repair",
        8500.0,
        24.0,
        "TECH003",
        "Transmission assembly, cooling lines",
        "2024-11-05",
        6,
        24.0,
      ],
    ...
    const alertData = [
      [
        ...
        "RN003",
        "overdue",
        "Equipment return is 3 days overdue",
        "High",
        "2024-08-26 09:00:00",
        null,
        null,
      ...
      [
        ...
        null,
        "maintenance_due",
        "Preventive maintenance due in 2 days",
        "Medium",
        "2024-08-26 14:30:00",
        null,
        null,
      ...
      [
        ...
        "RN002",
        "geofence_violation",
        "Equipment detected outside designated work area",
        "Medium",
        "2024-08-27 16:45:00",
        null,
        null,
    ...
    const anomalyData = [
      ...
      [
        ...
        "2024-08-25 10:15:00",
        0.68,
        "Unusual operating pattern detected",
        8.0,
        3.2,
        6.0,
        "Low",
        "Resolved",
        "Normal variation in work pattern",
        "2024-08-28 09:00:00",
      ],
    ];
